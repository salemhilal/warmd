...
# ripped some shit out of curplay.cgi to make this, ams1@wrct.org, 2009 april
...
print "<a href=\"http://db.wrct.org/playlist.cgi?id=$$row{PlayListID}\">View the current playlist</a>";
